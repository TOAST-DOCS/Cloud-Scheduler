...
!!! danger "주의"
    대상 템플릿을 이용하여 생성한 템플릿으로 일정을 생성하는 경우, 대상 템플릿의 민감 정보는 보안을 위해 입력되지 않습니다.
    일정 생성을 진행하며 민감 정보를 새로 입력하세요.
...
!!! danger "주의"
    대상 템플릿을 이용하여 생성한 템플릿 복사 시, 대상 템플릿의 민감 정보는 보안을 위해 복사하지 않습니다.
    템플릿 복사를 진행하며 민감 정보를 새로 입력하세요.
